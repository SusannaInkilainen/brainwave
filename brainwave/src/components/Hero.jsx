...
const Hero = () => {
    ...
    return (
        ...
        <div className="container relative" ref={parallaxRef}>
            ...
            mx-auto text-center mb-[3.875rem] md:mb lg:mb:[6rem]">
                <h1 className="h1 mb-6">Tsiikaile mahdollisuuksia &nbsp;AI&nbsp; chattailyllä {` `}
                ...
                <p className="body-1 max-w-3xl mx-auto mb-6 text-n-2 lg:mb-8">Vapauta tekoälyn voima käyttämällä Brainwave. Päivitä produktiivisuutesi uudelle tasolle.</p>

                <Button href="/#pricing" white>Aloita tästä</Button>
            </div>
